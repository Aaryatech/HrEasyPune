...
<title>Apology Letter - Misbehaviour</title>
	...
	<table width="100%"
		...
		<tr>
			<td colspan="2" align="center"><table width="100%">
					...
					<tr>
						<td width="100%"><p style="color: #000;">विषय- गैरवर्तन
								केल्याबद्दल माफीनामा</p></td>
					...
					<tr>
						<td width="100%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<p style="color: #000;">
								...
								${fromdate} या तारखेला गैरवर्तन केले आहे .हि पूर्णपणे माझी चूक
								आहे व मला मान्य आहे.यानंतर अशी चूक पुन्हा केल्यास व्यवस्थापन
					...
					<tr>
						<td width="100%">
							<p style="color: #000;">
								...
								<br>चूक - ${reason}<br> <br>दिनांक - ${date} <br>
								<br>सही--
							</p>
						</td>
