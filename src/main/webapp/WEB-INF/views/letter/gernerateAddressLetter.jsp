	...
	<table width="100%"
		...
		<tr>
			<td colspan="2" align="center"><table width="100%">
					...
					<tr>
						<td width="100%">
							<p style="color: #000; margin-top: 70px;">${date}</p>
						</td>
					...
					<tr>
						<td width="100%">
							<p style="color: #000;">This is to certify that Mr./ Mrs./
								Miss -
								${empDetail.firsName}&nbsp;${empDetail.middleName}&nbsp;${empDetail.surname}
								is a employee of ${cmpName} since ${fromdate}.As per our records
								his address is At-${address}.</p>
						</td>
