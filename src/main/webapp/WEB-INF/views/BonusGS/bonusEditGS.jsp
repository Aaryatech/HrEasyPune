					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-header header-elements-inline">
								<h5 class="pageTitle"><i class="icon-list-unordered"></i> Edit Bonus</h5>
							</div>
							...
							<div class="card-body">
								...
								<form action="${pageContext.request.contextPath}/submitEditBonusGS"
									...
									<div class="form-group row">
										...
										<div class="col-md-6">
											<label class="col-form-label text-info font-weight-bold col-lg-5 float" for="shiftName">Exgratia 
											% <span style="color: red">* </span>:
										</label>
										<div class="col-lg-7 float">
											<input type="text" class="form-control"
