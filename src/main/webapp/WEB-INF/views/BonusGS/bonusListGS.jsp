 ...
 --%>
										<td class="text-center"><c:if test="${editAccess == 0}">
												<c:if test="${bonusList.exInt2 == 0}">
													<a
														href="${pageContext.request.contextPath}/editBonusGS?bonusId=${bonusList.exVar1}"
												...
												<a
													href="${pageContext.request.contextPath}/showEmpListToAssignBonusGS?bonusId=${bonusList.exVar1}"
													class="list-icons-item text-primary-600"
											...
											<c:if test="${bonusList.bonusAppBelowAmount == 1}">
												...
												<a
													href="${pageContext.request.contextPath}/showEmpListToAssignExgratiaGS?bonusId=${bonusList.exVar1}"
													class="list-icons-item text-warning" data-popup="tooltip"
													title="Assign Exgratia" data-original-title="Assign Exgratia"><i
													class="icon-gift "></i></a>
											</c:if></td>
									</tr>
								</c:forEach>
							...
							bootbox
									.confirm({
										...
										callback : function(result) {
											if (result) {
												location.href = "${pageContext.request.contextPath}/deleteBonusGS?bonusId="
														+ uuid;
