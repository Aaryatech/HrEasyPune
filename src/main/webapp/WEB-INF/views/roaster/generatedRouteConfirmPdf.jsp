...
<title>Route Confirmation List</title>
...
<body>
					...
					<tr>
						...
						<td width="53.33%" valign="top"
							...
							<h4 style="font-weight: bold; margin: 0px; font-size: 14px;"
								align="center">Route Confirmation List</h4>
						</td>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			<th align="center"
				style="border-bottom: 1px solid #313131; border-left: 1px solid #313131;"
				valign="top" width="10%">KM</th>
			<th align="center"
				style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 2px;"
				valign="top">Incentive</th>
		...
		<c:forEach items="${list}" var="list" varStatus="count">
			<tr>
				<td
					...
					valign="top" width="7%" align="center">${count.index+1}</td>
				<td
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 5px;"
				...
				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 5px;"
					valign="top" width="10%">${list.km}</td>
				<td align="right"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 5px;"
					valign="top">${list.incentive}</td>
			</tr>
		</c:forEach>
