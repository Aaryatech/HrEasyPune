						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<label class="col-form-label col-lg-2"> AD001</label> <label
										class="col-form-label col-lg-2"> Driver Name : </label> <label
										class="col-form-label col-lg-2">Akshay Kasar</label>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-1"> Long Route: </label> <label
								...
								<div class="table-responsive">
									<table
										...
										<tbody>
											...
											<tr>
												<td class="text-center">01-06-2020</td>
												<td>Aurangabad-nashik</td>
