			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						<h5 class="pageTitle">
							<i class="icon-list-unordered"></i>Send Notification Between Date
						</h5>
					...
					<div class="card-body">
						...
						%><form
							action="${pageContext.request.contextPath}/submitSendNotification"
							...
							<div class="form-group row">
								...
								<button type="submit" class="btn bg-blue ml-3 legitRipple"
									id="submtbtn1">Send Notification</button>
						...
						<%-- <c:if test="${list.size()>0}">
							...
							<div class="text-center">
								...
								<button type="button" class="btn blue_btn ml-3 legitRipple"
									id="excel" onclick="getProgReport(0,'excelForRoutePlanList')">
									Excel</button>
							</div>
