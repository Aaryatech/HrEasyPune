...
<body>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						<h5 class="pageTitle">
							<i class="icon-list-unordered"></i>Roaster Confirmation List
						</h5>
					...
					<div class="card-body">
						...
						%><form
							action="${pageContext.request.contextPath}/routeConfirmList"
							...
							<tbody>
								...
								<c:forEach items="${list}" var="list" varStatus="count">
									<tr>
										...
										<td class="text-right">${list.km}</td>
										<td class="text-right">${list.incentive}</td>
									</tr>
								</c:forEach>
						...
						<c:if test="${list.size()>0}">
							...
							<div class="text-center">
								...
								<button type="button" class="btn blue_btn ml-3 legitRipple"
									id="excel"
									onclick="getProgReport(0,'excelForRouteConfirmList')">
									Excel</button>
							</div>
	...
	<script type="text/javascript">
		function commonPdf() {
			...
			window.open('pdfForReport?url=/pdf/generatedRouteConfirmPdf/'
					+ date);
