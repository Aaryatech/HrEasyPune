			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-header header-elements-inline">
						<table width="100%">
							<tr width="100%">
								<td width="60%"><h5 class="pageTitle"><i class="icon-list-unordered"></i> Default Holiday List</h5></td>
									...
									<tr>
										...
										<td class="text-center"><c:if test="${editAccess == 0}">
												...
												<a href="javascript:void(0)"
													...
													data-uuid="${holiday.holidayId}" data-popup="tooltip"
							...
							bootbox
									.confirm({
										...
										callback : function(result) {
											if (result) {
												location.href = "${pageContext.request.contextPath}/deleteHolidayMaster?holidayId="
														+ uuid;
