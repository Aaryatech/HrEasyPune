					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form
									action="${pageContext.request.contextPath}/updateSettingValue"
									id="submitInsertLocaion" method="post">
								
									<input type="hidden" value="${setting.exVar1}" id="settingId"
										name="settingId">
									...
									<div class="form-group row mb-0">
										<div class="col-lg-10 ml-lg-auto">
											...
											<a
												href="${pageContext.request.contextPath}/showSettingLabelsList"><button
	...
	<script>
		...
		$(document).ready(function($) {
			...
			$("#submitInsertLocaion").submit(function(e) {
				...
				if (parseInt($("#set_value").val())<1 || !$("#set_value").val()) {

					isError = true;

					$("#error_set_value").show()
					//return false;
				} else {
					$("#error_set_value").hide()
				}
