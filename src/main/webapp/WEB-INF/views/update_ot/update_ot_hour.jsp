...
<body>
								...
								<div class="tab-content">
										...
										<div class="form-group row">
											...
											<div class="col-md-6">
															...
															<c:forEach items="${empList}" var="emp">
																	<c:choose>
																		<c:when test="${emp.empId eq empId}">
																			<option value="${emp.exVar1}" selected>${emp.firstName} ${emp.surname} ${emp.empCode}</option>
																		</c:when>
																		<c:otherwise>
																			<option value="${emp.exVar1}">${emp.firstName} ${emp.surname} ${emp.empCode}</option>
																		</c:otherwise>
																	</c:choose>
															</c:forEach>
												...
												<!-- <label for="staticEmail" class="col-md-1 col-form-label">Month
													...
													<input type="text" placeholder="Select Month" name="selectMonth" id="datepicker"
									...
									<form
										...
										<table class="table datatable-fixed-left_custom" width="100%"
											...
											<tbody>
											<c:forEach items="${dailyList}" var="daily" varStatus="count">
											<tr>
	...
	function getEmpOtdata(){
		 ...
		 var month="OCT";
		 var empId="Pppp";
		    form.action ="searchEmpOTDataForm?month="+month+"&empId="+empId;
		    form.submit();
