			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						%>
						<form
							action="${pageContext.request.contextPath}/calculationArears"
							id="selectMonthForPayRoll" method="post">
							<div class="form-group row">
								<label
									class="col-form-label text-info font-weight-bold col-lg-2"
									for="fromMonth"> Select From Month <span
								...
								<label
									class="col-form-label text-info font-weight-bold col-lg-2"
									for="datepicker"> Select To Month <span
									style="color: red">* </span> :
								</label>
								<div class="col-md-2">
							...
							<span class="validation-invalid-label" id="error_emp"
								style="display: none;">Select Minimum one employee.</span> <br>
