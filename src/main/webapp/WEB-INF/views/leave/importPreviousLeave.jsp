								...
								<table width="100%">
									<tr width="100%">
										<td width="60%"><h5 class="pageTitle">
												<i class="icon-list-unordered"></i> Import Previous Leave
												Data
											</h5></td>
										<td width="40%" align="right"><a
											href="${pageContext.request.contextPath}/carryForwordLeave"
											class="">
												<button type="button"
													class="btn blue_btn legitRipple legitRipple-empty">Back</button>
										</a></td>
									</tr>
								</table>
							</div>
								...
								<div class="rows">
									<div class="col-md-12">
										<div class="row">
											<div class="col-md-12">
												<form
													action="${pageContext.request.contextPath}/submitUploadLeaveData"
													...
													<div class="form-group row">
														...
														<div class="col-md-4">
															...
															<a
																href="${pageContext.request.contextPath}/carryForwordLeave"><button
