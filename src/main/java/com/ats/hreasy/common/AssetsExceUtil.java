...
public class AssetsExceUtil {
	
	public static int incCellValue=5;
	...
	public static XSSFWorkbook createWorkbook(List<ExportToExcel> exportToExcelList,String instName,String reportName,String filterValue,String reportSummary,Character endChar) throws IOException {
       ...
       System.err.println("instName"+instName);
		...
		//Character endChar='H';
	        ...
	        CellStyle style04=wb.createCellStyle();
	        style04.setAlignment(CellStyle.ALIGN_LEFT);
	        style04.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
		    
	        Row titleRow04 = sheet.createRow(3);
	        titleRow04.setHeightInPoints(20);
	        titleRow04.setRowStyle(style04);
	        
	        Cell titleCell04 = titleRow04.createCell(0);
	        titleCell04.setCellStyle(style2);
	        titleCell04.setCellValue(filterValue);
