...
public class RoutePlanDetailWithName {
	...
	public String toString() {
		return "RoutePlanDetailWithName [planDetailId=" + planDetailId + ", planHeadId=" + planHeadId + ", routeId="
				+ routeId + ", driverId=" + driverId + ", isoffdayIsff=" + isoffdayIsff + ", typeId=" + typeId
				+ ", routeName=" + routeName + ", frName=" + frName + ", frIds=" + frIds + ", lateMark=" + lateMark
				+ ", lateMin=" + lateMin + ", km=" + km + ", incentive=" + incentive + ", delStatus=" + delStatus
				+ ", extraInt1=" + extraInt1 + ", extraInt2=" + extraInt2 + ", extraVar2=" + extraVar2 + ", extraVar1="
				+ extraVar1 + ", firstName=" + firstName + ", surname=" + surname + "]";
	}
