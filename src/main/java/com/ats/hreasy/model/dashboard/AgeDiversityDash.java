...
public class AgeDiversityDash {
	...
	public String toString() {
		return "AgeDiversityDash [uniKey=" + uniKey + ", ageRange1=" + ageRange1 + ", ageRange2=" + ageRange2
				+ ", ageRange3=" + ageRange3 + ", ageRange4=" + ageRange4 + ", ageRange5=" + ageRange5 + ", ageRange6="
				+ ageRange6 + ", ageRange7=" + ageRange7 + ", ageRange8=" + ageRange8 + ", ageRange9=" + ageRange9
				+ ", ageRange10=" + ageRange10 + ", ageRange11=" + ageRange11 + "]";
	}
