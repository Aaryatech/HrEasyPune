...
public class AssetAMCExpiryReport {
	...
	public String toString() {
		return "AssetAMCExpiryReport [id=" + id + ", assetId=" + assetId + ", assetCode=" + assetCode + ", assetName="
				+ assetName + ", assetCatId=" + assetCatId + ", catName=" + catName + ", compName=" + compName
				+ ", contactNo1=" + contactNo1 + ", conatctPersonName=" + conatctPersonName + ", contactPersonNo="
				+ contactPersonNo + ", locName=" + locName + ", amcFrDate=" + amcFrDate + ", amcToDate=" + amcToDate
